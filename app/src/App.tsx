...
function AppInner() {
  ...
  const { getState, saveState, isRunningMapRef, unreadIdsRef, gateChannelIdsRef, reviewChannelIdsRef, unreadCount, markRead, markAllRead, clearReviewPill, subscribeChatEvents } = useChatStateStore({
    channels,
    selectedId,
    onAppEvent,
  });
