...
function AppInner() {
  ...
  const { getState, saveState, isRunningMapRef, unreadIdsRef, gateChannelIdsRef, reviewChannelIdsRef, unreadCount, markRead, markAllRead, subscribeChatEvents } = useChatStateStore({
    channels,
    selectedId,
    onAppEvent,
  });
