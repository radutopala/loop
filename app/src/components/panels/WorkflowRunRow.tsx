  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <span style={{ color: colors.textLight, fontWeight: 600, flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{run.workflow_name}</span>
      ...
      {run.dir_path && <div style={{ color: colors.textDim, fontSize: 10, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{run.dir_path}</div>}
      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
        <span
          style={{
            padding: "1px 5px",
        ...
        {run.status === "paused" && run.paused_node_id && <span style={{ fontSize: 10, color: colors.textDim }}>at {run.paused_node_id}</span>}
        <div style={{ flex: 1 }} />
