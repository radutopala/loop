...
export interface OverviewTabProps {
  display: { signal: number; geo_mean: number; metrics: { name: string; score: number; raw: number }[]; tiles: QualityFileTile[]; rules?: { failed: QualityRule[] }; scanned_at: string; branch: string } | null;
