...
func newMockChannelRows() *sqlmock.Rows {
	return sqlmock.NewRows([]string{"id", "channel_id", "guild_id", "name", "dir_path", "parent_id", "platform", "active", "session_id", "permissions", "worktree", "base_branch", "locked", "model_override", "effort_override", "fork_pending", "task_id", "created_at", "updated_at"})
}
