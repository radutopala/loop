...
func newMockMessageRows() *sqlmock.Rows {
	return sqlmock.NewRows([]string{"id", "chat_id", "channel_id", "msg_id", "author_id", "author_name", "content", "is_bot", "is_processed", "is_triggered", "is_running", "priority", "mode", "created_at", "kind", "chain_position", "tool_use_id", "tool_name", "is_error"})
}
