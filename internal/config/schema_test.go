...
func (s *SchemaSuite) TestGatesNestedObject() {
	...
	require.Equal(s.T(), []any{"source_path_in", "equals", "contains_any", "starts_with_any", "not_in", "capability_not_in", "present", "empty_array"}, jsonChecks.Items.Properties["op"].Enum)
