...
func (s *ServerSuite) SetupTest() {
	...
	s.mux.HandleFunc("POST /api/threads/{id}/fork", s.srv.handleForkThread)
	...
	s.mux.HandleFunc("GET /api/channels/{id}/container-stats", s.srv.handleContainerStats)
	s.mux.HandleFunc("GET /api/asks/pending", s.srv.handleListPendingAsks)
	s.mux.HandleFunc("GET /api/plans/pending", s.srv.handleListPendingPlans)
	...
	s.mux.HandleFunc("GET /api/channels/{id}/composer-history", s.srv.handleComposerHistory)
	s.mux.HandleFunc("GET /api/channels/{id}/queued", s.srv.handleListQueuedMessages)
	s.mux.HandleFunc("POST /api/channels/{id}/queued/reorder", s.srv.handleReorderQueuedMessages)
	...
	s.mux.HandleFunc("GET /api/channels/{id}/raw/{root}/{path...}", s.srv.handleRawFile)
	...
	s.mux.HandleFunc("POST /api/channels/{id}/description", s.srv.handleSetChannelDescription)
	s.mux.HandleFunc("POST /api/channels/{id}/ticket", s.srv.handleSetChannelTicketURL)
	...
	s.mux.HandleFunc("PUT /api/playground", s.srv.playground.handlePlaygroundUpdate)
	s.mux.HandleFunc("GET /api/playground", s.srv.playground.handlePlaygroundGet)
	s.mux.HandleFunc("DELETE /api/playground", s.srv.playground.handlePlaygroundDelete)
	s.mux.HandleFunc("GET /api/playground/items", s.srv.playground.handlePlaygroundList)
	s.mux.HandleFunc("PUT /api/playground/file", s.srv.playground.handlePlaygroundFileWrite)
	...
	s.mux.HandleFunc("DELETE /api/playground/share", s.srv.playground.handlePlaygroundUnshare)
	s.mux.HandleFunc("GET /api/playground/share", s.srv.playground.handlePlaygroundShareList)
	...
	s.mux.HandleFunc("POST /api/channels/{id}/quality/scan", s.srv.quality.handleQualityScan)
	s.mux.HandleFunc("DELETE /api/channels/{id}/quality/scan", s.srv.quality.handleQualityScanCancel)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/snapshot", s.srv.quality.handleQualitySnapshot)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/cycles", s.srv.quality.handleQualityCycles)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/metrics", s.srv.quality.handleQualityMetrics)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/diagnostics", s.srv.quality.handleQualityDiagnostics)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/rules", s.srv.quality.handleQualityRules)
	s.mux.HandleFunc("POST /api/channels/{id}/quality/whatif", s.srv.quality.handleQualityWhatif)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/evolution", s.srv.quality.handleQualityEvolution)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/c4", s.srv.quality.handleQualityC4)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/bugfactor", s.srv.quality.handleQualityBugFactor)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/complexity", s.srv.quality.handleQualityComplexity)
	s.mux.HandleFunc("GET /api/channels/{id}/quality/clones", s.srv.quality.handleQualityClones)
