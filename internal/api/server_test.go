...
func (m *MockIncomingMessageHandler) HandleIncomingMessage(ctx context.Context, channelID, authorID, content, mode string, worktree bool, branch, worktreePath string) {
	m.Called(ctx, channelID, authorID, content, mode, worktree, branch, worktreePath)
}
