...
func (s *ServerSuite) SetupTest() {
	...
	s.mux.HandleFunc("PUT /api/playground/share", s.srv.handlePlaygroundShare)
	s.mux.HandleFunc("DELETE /api/playground/share", s.srv.handlePlaygroundUnshare)
	s.mux.HandleFunc("GET /api/playground/share", s.srv.handlePlaygroundShareList)
