...
func (s *CommandsSuite) TestSubcommands() {
	...
	expected := map[string]discordgo.ApplicationCommandOptionType{
		...
		"shortcuts":   discordgo.ApplicationCommandOptionSubCommand,
		"shortcut":    discordgo.ApplicationCommandOptionSubCommand,
		"workflow":    discordgo.ApplicationCommandOptionSubCommandGroup,
