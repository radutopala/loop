...
func (s *MCPMemorySuite) TestListToolsIncludesMemory() {
	...
	require.Len(s.T(), res.Tools, 40) // 16 base + 2 memory + 3 playground + 2 shortcut + 1 chat_component + 12 quality + 1 rename + 1 description + 1 ticket + 1 review
