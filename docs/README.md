...
- [**Quality**](quality.md) — Architectural quality engine: six graph- and function-level metrics aggregated into `quality_signal`, treemap, rules, live rescan
...
- [**Git**](git.md) — Git panel: status, staged/unstaged diffs, commits, branches, PR creation
...
- [**Troubleshooting**](troubleshooting.md) — Common issues: daemon startup, security-gate approvals, Docker proxy blocks, memory/Ollama, LaunchAgents permissions, corporate TLS/proxy Docker build failures
