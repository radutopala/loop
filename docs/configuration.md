...
| `claude_model` | `string` | `"claude-sonnet-5"` | Claude model to use. Options: `"claude-opus-5-5"`, `"claude-opus-5"`, `"claude-sonnet-5"`, `"claude-fable-5-1"`, `"claude-fable-5"`, `"claude-opus-4-8"`. |
